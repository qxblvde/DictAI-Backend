...
const file_audio_proto_rawDesc = "" +
	...
	"\acontent\x18\x03 \x01(\fR\acontent2M\n" +
	"\x12AudioIngestService\x127\n" +
	"\bGetAudio\x12\x16.audio.GetAudioRequest\x1a\x11.audio.AudioChunk0\x01B7Z5github.com/DictAI/Microservices/contracts/audio;audiob\x06proto3"
...
var file_audio_proto_goTypes = []any{
	(*GetAudioRequest)(nil), // 0: audio.GetAudioRequest
	(*AudioChunk)(nil),      // 1: audio.AudioChunk
}
var file_audio_proto_depIdxs = []int32{
	0, // 0: audio.AudioIngestService.GetAudio:input_type -> audio.GetAudioRequest
	1, // 1: audio.AudioIngestService.GetAudio:output_type -> audio.AudioChunk
